      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pt-6 pb-28">
        ...
        <header className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[11px] font-semibold tracking-[3px] uppercase text-amber-500">Inversiones</p>
              <h1 className="text-[17px] font-black leading-none text-gray-900" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                Multipower
              </h1>
            </div>
          </div>
          ...
          {/* BCV badge */}
          <div className="flex items-center gap-2 rounded-2xl px-4 py-2.5 shadow-sm border"
            style={{ background: '#fff', borderColor: '#fde68a', boxShadow: '0 2px 12px rgba(251,191,36,0.15)' }}>
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
            <div>
              <p className="text-[9px] font-semibold tracking-widest text-gray-400 uppercase leading-none">BCV</p>
              <p className="text-[15px] font-black text-amber-500 leading-tight" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        {/* ── HERO LABEL ─────────────────────────────────────────────────── */}
        <div className="mb-6">
          <h2 className="text-[28px] font-black text-gray-900 leading-tight" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            ¿Cuánto quieres<span className="text-amber-500"> enviar?</span>
          </h2>
          <p className="text-[13px] text-gray-400 mt-1">Tasas en tiempo real • Sin comisiones ocultas</p>
        </div>
        ...
        <div className="rounded-3xl p-5 mb-4 shadow-sm border"
          ...
          <p className="text-[10px] font-bold tracking-[3px] text-gray-400 uppercase mb-4">Ruta de envío</p>
        ...
        <div className="rounded-3xl p-5 mb-4 border"
          style={{ background: '#fff', borderColor: '#f3f4f6', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          <p className="text-[10px] font-bold tracking-[3px] text-gray-400 uppercase mb-4">Monto a enviar</p>
          <div className="flex items-center rounded-2xl overflow-hidden border transition-all duration-200"
            style={{ borderColor: '#e5e7eb', background: '#fafafa' }}>
            <div className="flex-shrink-0 px-4 py-4 flex items-center gap-2 border-r"
              style={{ background: 'linear-gradient(135deg, #fff8e1, #fef3c7)', borderColor: '#e5e7eb' }}>
              <span className="text-xl">{originCountry?.flag}</span>
              <span className="text-[13px] font-black text-amber-600 tracking-wide">{originCountry?.currency}</span>
            </div>
            <input
              type="number"
              value={amount}
        ...
        <div className="rounded-3xl p-5 mb-4 border"
          style={{ background: '#fff', borderColor: '#f3f4f6', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          <p className="text-[10px] font-bold tracking-[3px] text-gray-400 uppercase mb-4">Método de pago en Venezuela</p>
            ...
            {[
              ...
              <button key={method.value} onClick={() => setPaymentMethod(method.value)}
                ...
                {paymentMethod === method.value && (
                  <span className="ml-auto w-4 h-4 rounded-full flex items-center justify-center" style={{ background: '#f59e0b' }}>
...
```
        ...
        <button
          ...
          style={{
            background: canContinue ? 'linear-gradient(135deg, #f59e0b 0%, #fbbf24 50%, #f59e0b 100%)' : '#e5e7eb',
            color: canContinue ? '#1a0a00' : '#9ca3af',
            boxShadow: canContinue ? '0 8px 32px rgba(245,158,11,0.4), 0 2px 8px rgba(245,158,11,0.2)' : 'none',
